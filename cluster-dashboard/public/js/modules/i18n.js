...
const translations = {
  tr: {
    ...
    // Topbar Extras
    "topbar_demo_live": "Canlı Küme",
    "topbar_demo_title": "Canlı Küme / Demo Simülasyonu Modu",
    "topbar_voice_off": "Ses: Kapalı",
    "topbar_voice_on": "Ses: Açık",
    "topbar_voice_title": "NOC Sesli Anons Sistemi",
    "topbar_cmd_title": "Komut Paleti (Ctrl + K)",
    "topbar_cluster_title": "Aktif Küme",
    "topbar_cluster_primary": "☸️ Birincil Küme (Aktif)",
    "topbar_cluster_add": "➕ Yeni Küme...",
    "topbar_logout": "Çıkış",
    "topbar_logout_title": "Oturumu Kapat",

    // Modules 35 - 52
    "sidebar_pipeline_gitops": "GİTOPS & YAPAY ZEKA KONSOLU",
    "ops_nav_gitops": "GitOps & Dağıtım (Argo)",
    "ops_nav_canary_traffic": "Canary Trafik Bölme",
    "ops_nav_policy_engine": "OPA & Kyverno Kalkanı",
    "ops_nav_pod_terminal": "Pod Canlı Web Terminali",
    "ops_nav_log_anomaly_ai": "AI Log Anomali Tespiti",
    "ops_nav_executive_report": "C-Level SLA Raporu",
    "sidebar_pipeline_advanced": "İLERİ ALTYAPI & DONANIM VİZYONU",
    "ops_nav_ai_gpu": "Kurumsal LLM & GPU Masası",
    "ops_nav_holo_cluster": "3D Holo-Küme NOC Ekranı",
    "ops_nav_bare_metal": "Bare-Metal & IPMI Konsolu",
    "ops_nav_flamegraph": "eBPF Canlı Alev Grafikleri",
    "ops_nav_edge_mesh": "Edge & Saha Şube Ağı",
    "ops_nav_cluster_migrate": "Canlı Küme Göçü & Klonlama",
    "ops_nav_secret_radar": "Gizli Anahtar & Şifre Radarı",
    "ops_nav_voice_alerts": "NOC Sesli Anons Sistemi",
  ...
  en: {
    ...
    // Topbar Extras
    "topbar_demo_live": "Live Cluster",
    "topbar_demo_title": "Live Cluster / Demo Simulation Mode",
    "topbar_voice_off": "Voice: Off",
    "topbar_voice_on": "Voice: On",
    "topbar_voice_title": "NOC Voice Alert System",
    "topbar_cmd_title": "Command Palette (Ctrl + K)",
    "topbar_cluster_title": "Active Cluster",
    "topbar_cluster_primary": "☸️ Primary Cluster (Active)",
    "topbar_cluster_add": "➕ Add New Cluster...",
    "topbar_logout": "Exit",
    "topbar_logout_title": "Log Out Session",

    // Modules 35 - 52
    "sidebar_pipeline_gitops": "GITOPS & AI CONSOLE",
    "ops_nav_gitops": "GitOps & Delivery (ArgoCD)",
    "ops_nav_canary_traffic": "Canary Traffic Splitting",
    "ops_nav_policy_engine": "OPA & Kyverno Shield",
    "ops_nav_pod_terminal": "Pod Interactive Web Terminal",
    "ops_nav_log_anomaly_ai": "AI Log Anomaly Detection",
    "ops_nav_executive_report": "Executive C-Level SLA Report",
    "sidebar_pipeline_advanced": "ADVANCED INFRA & HARDWARE STUDIOS",
    "ops_nav_ai_gpu": "Enterprise LLM & GPU Studio",
    "ops_nav_holo_cluster": "3D Holographic Cluster NOC",
    "ops_nav_bare_metal": "Bare-Metal & IPMI Console",
    "ops_nav_flamegraph": "eBPF Live Flamegraphs",
    "ops_nav_edge_mesh": "Edge & Autonomous Branch Mesh",
    "ops_nav_cluster_migrate": "Live Cluster Migration & Clone",
    "ops_nav_secret_radar": "Secret & Password Leak Radar",
    "ops_nav_voice_alerts": "NOC Voice Alert System",
...
const phraseDictionary = [
  ...
  // Modules 35 - 52 & Advanced Studios
  ["GİTOPS & YAPAY ZEKA KONSOLU", "GITOPS & AI CONSOLE"],
  ["GitOps & Dağıtım (Argo)", "GitOps & Delivery (ArgoCD)"],
  ["Canary Trafik Bölme", "Canary Traffic Splitting"],
  ["OPA & Kyverno Kalkanı", "OPA & Kyverno Shield"],
  ["Pod Canlı Web Terminali", "Pod Interactive Web Terminal"],
  ["AI Log Anomali Tespiti", "AI Log Anomaly Detection"],
  ["C-Level SLA Raporu", "Executive C-Level SLA Report"],
  ["İLERİ ALTYAPI & DONANIM VİZYONU", "ADVANCED INFRA & HARDWARE STUDIOS"],
  ["Kurumsal LLM & GPU Masası", "Enterprise LLM & GPU Studio"],
  ["3D Holo-Küme NOC Ekranı", "3D Holographic Cluster NOC"],
  ["Bare-Metal & IPMI Konsolu", "Bare-Metal & IPMI Console"],
  ["eBPF Canlı Alev Grafikleri", "eBPF Live Flamegraphs"],
  ["Edge & Saha Şube Ağı", "Edge & Autonomous Branch Mesh"],
  ["Canlı Küme Göçü & Klonlama", "Live Cluster Migration & Clone"],
  ["Gizli Anahtar & Şifre Radarı", "Secret & Password Leak Radar"],
  ["NOC Sesli Anons Sistemi", "NOC Voice Alert System"],
  ["eBPF Kernel WAF & Tehdit Haritası", "eBPF Kernel WAF & Threat Map"],
  ["Küme Çöp & Zombi Temizleyici", "Cluster Janitor & Zombie Purger"],
  ["YAML Zaman Makinesi & Diff", "YAML Time-Machine & Visual Diff"],
  ["Canlı Metrik Osiloskopu", "Real-time Metrics Oscilloscope"],

  // Studio Panes Titles & Badges
  ["eBPF Canlı Alev Grafikleri (Continuous Flamegraphs)", "eBPF Live Flamegraphs (Continuous Profiling)"],
  ["Uygulama kodunuza tek bir satır dahi eklemeden, kernel stack-trace ile CPU darboğazlarını ve bellek sızıntılarını alev grafiğinde analiz edin.", "Analyze CPU bottlenecks and memory leaks using kernel stack traces without modifying application code."],
  ["Edge (Uç Birim) & Şube Kümeleri Otonom Yönetimi", "Edge & Autonomous Branch Cluster Management"],
  ["Fabrika, gemi ve şubelerdeki uzak RKE2/K3s uç lokasyonları. İnternet koptuğunda dahi otonom çalışır ve 4G/5G/Starlink üzerinden sıkıştırılmış senkronizasyon sağlar.", "Remote RKE2/K3s edge locations in factories, vessels, and branches. Operates autonomously during outages and syncs over 4G/5G/Starlink."],
  ["Sıfır Kesintiyle Canlı Küme Göçü & Klonlama", "Zero-Downtime Live Cluster Migration & Cloning"],
  ["Proxmox'tan VMware vCenter'a veya Genel Bulutlara tüm PV kalıcı diskleri, Ingress ve Secret'ları veri kaybı olmadan taşıyın ve canlı RTO süresini ölçün.", "Migrate all PV storage, Ingress, and Secrets from Proxmox to VMware vCenter or Public Clouds with zero data loss."],
  ["Gizli Anahtar & Şifre Sızıntısı Radarı", "Secret Key & Password Leak Radar"],
  ["YAML manifestoları, ConfigMap'ler ve Pod ortam değişkenlerinde açıkta unutulmuş AWS key'leri, veritabanı şifreleri ve SSH anahtarlarını tarayın ve Vault'a dönüştürün.", "Scan for exposed AWS keys, database passwords, and SSH keys in YAML manifests, ConfigMaps, and Pod env vars."],
  ["NOC Operasyon Odası Sesli Anons Sistemi", "NOC Operations Room Voice Alert System"],
  ["Veri merkezi ve kontrol odalarında ekrana bakılmadığında dahi kritik arızaları, failover geçişlerini ve saldırıları Türkçe sesli anons edin.", "Audibly announce critical incidents, failover transitions, and security attacks in datacenter control rooms."],
  ["🎙️ Sesli Anons Test & Simülasyon Masası", "🎙️ Voice Announcement Test & Simulation Desk"],
  ["📢 Arıza Anonsu Test Et", "📢 Test Outage Announcement"],
  ["🛡️ Güvenlik Uyarısı Test Et", "🛡️ Test Security Alert"],
  ["✨ İyileştirme Anonsu Test Et", "✨ Test Remediation Announcement"],
  ["Tarayıcınızın yerel <strong>HTML5 Web Speech API</strong> motoru kullanılmaktadır. Sıfır harici kütüphane veya ses paketi indirme gerektirmez.", "Uses your browser native <strong>HTML5 Web Speech API</strong> engine. Zero external libraries or voice packs required."],
  ["eBPF Kernel WAF & Canlı Siber Tehdit Haritası", "eBPF Kernel WAF & Live Cyber Threat Map"],
  ["Çekirdek düzeyinde SQL Injection, XSS ve bot saldırılarını sıfır kullanıcı alanı gecikmesiyle filtreleyin ve coğrafi IP bloklama uygulayın.", "Filter SQL Injection, XSS, and bot attacks at the kernel level with zero userspace latency and apply geo-blocking."],
  ["🔄 Tehditleri Tara", "🔄 Scan Threats"],
  ["Küme Çöp & Zombi Kaynak Temizleyicisi", "Cluster Garbage & Zombie Resource Purger"],
  ["Sahipsiz PVC diskleri, tamamlanmış ölü Job podlarını ve atıl ConfigMap nesnelerini temizleyerek disk ve RAM alanını geri kazanın.", "Reclaim disk and RAM by purging orphaned PVC disks, dead Jobs, and unused ConfigMaps."],
  ["🔍 Çöp Taraması Yap", "🔍 Scan Garbage & Zombies"],
  ["Kubernetes YAML Zaman Makinesi & Görsel Diff", "Kubernetes YAML Time-Machine & Visual Diff"],
  ["Kümeye uygulanmış geçmiş Deployment ve Ingress revizyonlarını yan yana kırmızı/yeşil diff ile karşılaştırın ve tek tıkla eski sürüme dönün.", "Compare past Deployment and Ingress revisions side-by-side with visual red/green diff and rollback with 1-click."],
  ["Canlı Kayan Metrik Osiloskopu", "Real-time Rolling Metrics Oscilloscope"],
  ["Düğümlerin ve podların son 60 saniyelik CPU, RAM, Disk IOPS ve Ağ bant genişliği performansını akıcı neon Canvas eğrileriyle izleyin.", "Monitor last 60 seconds of CPU, RAM, Disk IOPS and Network bandwidth with smooth neon Canvas curves."],
  ["🔵 CPU Yükü • 🟣 RAM Kullanımı • 🟡 Disk IOPS • 🟢 Ağ Throughput", "🔵 CPU Load • 🟣 RAM Usage • 🟡 Disk IOPS • 🟢 Network Throughput"],

  // Telemetry & Studio Dynamic Labels
  ["İncelenen HTTP/gRPC İstek", "Inspected HTTP/gRPC Requests"],
  ["Engellenen Çekirdek (eBPF) Saldırı", "Blocked Kernel (eBPF) Attacks"],
  ["Ortalama Paket Düşürme Süresi", "Avg Packet Drop Latency"],
  ["Coğrafi Tehdit Kaynakları & Geo-Blocking", "Geographic Threat Origins & Geo-Blocking"],
  ["Tespit Edilen Çekirdek Saldırı Türleri", "Detected Kernel Threat Vectors"],
  ["🚫 BLOKLU", "🚫 BLOCKED"],
  ["İzin Veriliyor", "Allowed"],
  ["saldırı", "attacks"],
  ["Kurtarılabilir Disk Alanı", "Reclaimable Storage"],
  ["Kurtarılabilir Bellek (RAM)", "Reclaimable Memory (RAM)"],
  ["Zombi ve Atıl Kubernetes Kaynakları", "Zombie & Stale Kubernetes Resources"],
  ["🧹 1-Tıkla Güvenli Temizlik Yap", "🧹 1-Click Safe Cleanup"],
  ["YAML Revizyon Zaman Çizelgesi", "YAML Revision Timeline"],
  ["Karşılaştırma & Görsel Diff İnceleyici", "Visual Side-by-Side Diff Inspector"],
  ["Canlı vs Kararlı Revizyon Farkı", "Live vs Stable Revision Differences"],
  ["Kırmızı: Kaldırılan / Değiştirilen Değerler", "Red: Removed / Modified Values"],
  ["Yeşil: Yeni Eklenen / Kararlı Değerler", "Green: Added / Stable Values"],
  ["Bu Sürüme Geri Al (Rollback)", "Rollback to this Revision"],
  ["Şu Anki Canlı Sürüm (Hatalı)", "Current Live Revision (Defective)"],
  ["Kararlı Sürüm", "Stable Revision"],
  ["Arşivlenmiş İlk Sürüm", "Archived Initial Release"],
  ["Taranan K8s Nesnesi", "Scanned K8s Objects"],
  ["Açıkta Kalan Şifre / Token", "Exposed Secrets / Tokens"],
  ["Son Tarama Saati", "Last Scan Timestamp"],
  ["🔍 Yeniden Derin Tarama Başlat", "🔍 Run Deep Scan Now"],
  ["İyileştirme Önerisi:", "Remediation Guide:"],
  ["Vault Secret Manifestosu Üret ➔", "Generate Vault Secret Manifest ➔"],
  ["Duraklat", "Pause"],
  ["Devam Et", "Resume"],
